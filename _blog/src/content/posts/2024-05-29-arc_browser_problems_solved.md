---
author: Acid
pubDatetime: 2024-05-29T00:00:00.000Z
title: "Arc浏览器Win版常见问题解决方法"
slug: arc_browser_problems_solved
featured: false
draft: false
tags:
  - 日记
  - bugfixes
  - Arc浏览器
description: "题记：本文解决Arc浏览器中的常见错误"
ogImage: /img/posts/arc_browser_problems_solved/cover.png
---
...
- 切换节点
- 耐心等待
![按钮变灰后稍等片刻](/img/posts/arc_browser_problems_solved/image-1.avif)
...
> [o298668.ingest.sentry.io:443](http://o298668.ingest.sentry.io:443)

**Arc的注册登录服务器：**

> 或许是以下之一[http://api.segment.io:443](http://api.segment.io:443)[http://clientstream.launchdarkly.com:443](http://clientstream.launchdarkly.com:443)[http://mobile.launchdarkly.com:443](http://mobile.launchdarkly.com:443)

### Arc浏览器关闭后无法再次打开或者完全无法打开

**建议先尝试在系统应用设置中修复或重置Arc，如果此举没有效果，再考虑以下方法。**

**以下内容因为时间推移已经失效**，外网 arc社区找出了arc打不开的根本原因，是因为一个叫做firestore的文件夹，每次都要删掉这个文件夹arc才能打开，但是删掉以后 arc sync 就会不工作一段时间，因此有人写了一个每次打开arc时自动删除firestore的脚本，我放在了网盘里，使用文档也在压缩包中，有需求自取：[https://pan.baidu.com/s/1sCapWEA9G-TeM4u1KWOCCA?pwd=acid](https://pan.baidu.com/s/1sCapWEA9G-TeM4u1KWOCCA?pwd=acid)
...
> 127.0.0.1[o298668.ingest.sentry.io](http://o298668.ingest.sentry.io)127.0.0.1[mobile.launchdarkly.com](http://mobile.launchdarkly.com)127.0.0.1[clientstream.launchdarkly.com](http://clientstream.launchdarkly.com)127.0.0.1[update.googleapis.com](http://update.googleapis.com)127.0.0.1[api.segment.io](http://api.segment.io)
...
> ping[o298668.ingest.sentry.io](http://o298668.ingest.sentry.io)
...
使用Utools**网页快开**插件，将Arc浏览器设置为默认打开的浏览器，其实这是我更推荐的方式，Utools很好用

![用Utools充当Arc浏览器的搜索框架](/img/posts/arc_browser_problems_solved/image-2.avif)
...
文章涉及的大部分文件，以及一些快捷键总结都打包放到网盘了，[使用方法参阅readme.md](http://xn--readme-vt9i240au85b93oysvte4g.md)，链接：

> [https://www.alipan.com/s/Aqy7dSLCAiM](https://www.alipan.com/s/Aqy7dSLCAiM)

以上只包括我遇到过的问题，如果还有其它有关问题，参阅以下文章：
1. 【Arc for windows beta版踩坑记录-哔哩哔哩】[https://b23.tv/pS8GEM8](https://b23.tv/pS8GEM8)
2. 【Arc for windows 几个问题解决方法。-哔哩哔哩】[https://b23.tv/8G1n1Na](https://b23.tv/8G1n1Na)
